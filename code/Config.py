...
def cfg():
    # Base configuration
    model_config = {"musdb_path" : r"D:\Ben\FinalProject\Github\train-test-dataset", # SET MUSDB PATH HERE, AND SET CCMIXTER PATH IN CCMixter.xml
                    "estimates_path" : r"D:\Ben\FinalProject\Github\source_estimate", # SET THIS PATH TO WHERE YOU WANT SOURCE ESTIMATES PRODUCED BY THE TRAINED MODEL TO BE SAVED. Folder itself must exist!
                    "data_path" : r"D:\Ben\FinalProject\Github\data", # Set this to where the preprocessed dataset should be saved
